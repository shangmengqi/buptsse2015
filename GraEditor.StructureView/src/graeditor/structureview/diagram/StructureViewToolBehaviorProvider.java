...
public class StructureViewToolBehaviorProvider extends DefaultToolBehaviorProvider{
	private ContextMenuEntry subMenu;
	
	public StructureViewToolBehaviorProvider(IDiagramTypeProvider diagramTypeProvider) {
