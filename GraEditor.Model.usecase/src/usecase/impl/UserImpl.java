...
public class UserImpl extends MinimalEObjectImpl.Container implements User {
	...
	protected EClass eStaticClass() {
		return UsecasePackage.Literals.USER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsecasePackage.USER__NAME, oldName, name));
	}
	...
	public EList<Usecase> getUsecase() {
		if (usecase == null) {
			usecase = new EObjectContainmentEList<Usecase>(Usecase.class, this, UsecasePackage.USER__USECASE);
		}
		return usecase;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UsecasePackage.USER__USECASE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UsecasePackage.USER__NAME:
				return getName();
			case UsecasePackage.USER__USECASE:
				return getUsecase();
		}
