...
public class PagePattern extends IdPattern implements IPattern{
	...
	protected PictogramElement doAdd(IAddContext context) {
		PageModule module = (PageModule) context.getNewObject();
		...
		Image file = gaService.createImage(containerShape, VocabularyImageProvider.PAGE);
		gaService.setLocationAndSize(file, context.getX(), context.getY(), width, height);
				
		String text = null;
		
		text = "" + ((PageModule)module).getTextContent();
	...
	public boolean isMainBusinessObjectApplicable(Object mainBusinessObject) {
		// TODO Auto-generated method stub
		return mainBusinessObject instanceof PageModule;
	}
