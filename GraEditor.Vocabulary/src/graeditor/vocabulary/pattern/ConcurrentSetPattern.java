...
public class ConcurrentSetPattern extends IdPattern implements IPattern{

	private static IColorConstant FONT_COLOR = ColorConstant.BLACK;
	
	public ConcurrentSetPattern() {
	...
	public Object[] create(ICreateContext context) {
		...
		ConcurrentSetModule concurrentSetModule = Vocabulary_modelFactory.eINSTANCE.createConcurrentSetModule();			
		concurrentSetModule.setName("ConcurrentSet");
		getDiagram().eResource().getContents().add(concurrentSetModule);
		addGraphicalRepresentation(context, concurrentSetModule);
		return new Object[] { concurrentSetModule };
	}
	...
	protected PictogramElement doAdd(IAddContext context) {
		ConcurrentSetModule module = (ConcurrentSetModule) context.getNewObject();
		Diagram diagram = (Diagram) context.getTargetContainer();
		
		IPeCreateService peCreateService = Graphiti.getPeCreateService();
		ContainerShape containerShape = peCreateService.createContainerShape(diagram, true);
		
		GraPropertyUtil.setValue(containerShape, "shape_id", "ConcurrentSet"+IDGenerator.generateID());
		...
		Image file = gaService.createImage(containerShape, VocabularyImageProvider.CONCURRENTSET);
...
//		containerAlgorithm.setLineWidth(5);
	...
	public boolean isMainBusinessObjectApplicable(Object mainBusinessObject) {
		// TODO Auto-generated method stub
		return mainBusinessObject instanceof ConcurrentSetModule;
	}
