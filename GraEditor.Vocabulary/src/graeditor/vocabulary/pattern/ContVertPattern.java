...
public class ContVertPattern extends IdPattern implements IPattern{
	
	private static IColorConstant FONT_COLOR = ColorConstant.BLACK;
	
	public ContVertPattern() {
	...
	public Object[] create(ICreateContext context) {
		...
		ContVertModule contVertModule = Vocabulary_modelFactory.eINSTANCE.createContVertModule();			
		contVertModule.setName("ContVert");
		contVertModule.setTextContent(value);
		getDiagram().eResource().getContents().add(contVertModule);
		addGraphicalRepresentation(context, contVertModule);
		return new Object[] { contVertModule };
	}
	...
	protected PictogramElement doAdd(IAddContext context) {
		ContVertModule module = (ContVertModule) context.getNewObject();
		Diagram diagram = (Diagram) context.getTargetContainer();
		
		IPeCreateService peCreateService = Graphiti.getPeCreateService();
		ContainerShape containerShape = peCreateService.createContainerShape(diagram, true);
		
		GraPropertyUtil.setValue(containerShape, "shape_id", "ContVert"+IDGenerator.generateID());
		...
		Image file = gaService.createImage(containerShape, VocabularyImageProvider.CONTVERT);
	...
	public boolean isMainBusinessObjectApplicable(Object mainBusinessObject) {
		// TODO Auto-generated method stub
		return mainBusinessObject instanceof ContVertModule;
	}
