...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Content Module</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.graeditor.flow_model.impl.ContentModuleImpl#getTextContent <em>Text Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContentModuleImpl extends FlowModuleImpl implements ContentModule {
	/**
	...
	protected EClass eStaticClass() {
		return Flow_modelPackage.Literals.CONTENT_MODULE;
	}
	...
	public void setTextContent(String newTextContent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Flow_modelPackage.CONTENT_MODULE__TEXT_CONTENT, oldTextContent, textContent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Flow_modelPackage.CONTENT_MODULE__TEXT_CONTENT:
