...
public class HorizontalLinePattern extends IdPattern implements IPattern{
	...
	public Object[] create(ICreateContext context) {
		HorizontalLineModule horizontalLine = Relation_modelFactory.eINSTANCE.createHorizontalLineModule();
	...
	protected PictogramElement doAdd(IAddContext context) {
		HorizontalLineModule moudle = (HorizontalLineModule) context.getNewObject();
	...
	public boolean isMainBusinessObjectApplicable(Object mainBusinessObject) {
		return mainBusinessObject instanceof HorizontalLineModule;
	}
