 ...
 * </p>
 * <ul>
 *   <li>{@link FlowView.impl.StartTagImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StartTagImpl extends MinimalEObjectImpl.Container implements StartTag {
	...
	protected EClass eStaticClass() {
		return FlowViewPackage.Literals.START_TAG;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowViewPackage.START_TAG__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FlowViewPackage.START_TAG__NAME:
				return getName();
		}
