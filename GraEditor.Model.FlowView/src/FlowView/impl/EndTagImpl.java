 ...
 * </p>
 * <ul>
 *   <li>{@link FlowView.impl.EndTagImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndTagImpl extends MinimalEObjectImpl.Container implements EndTag {
	...
	protected EClass eStaticClass() {
		return FlowViewPackage.Literals.END_TAG;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowViewPackage.END_TAG__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FlowViewPackage.END_TAG__NAME:
				return getName();
		}
