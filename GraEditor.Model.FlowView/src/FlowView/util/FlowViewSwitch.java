 ...
 * @generated
 */
public class FlowViewSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FlowViewPackage.FUNCTION: {
				Function function = (Function)theEObject;
				T result = caseFunction(function);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowViewPackage.VIEW: {
				View view = (View)theEObject;
				T result = caseView(view);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowViewPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowViewPackage.START_TAG: {
				StartTag startTag = (StartTag)theEObject;
				T result = caseStartTag(startTag);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowViewPackage.END_TAG: {
